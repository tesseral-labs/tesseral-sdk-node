...
export class Sessions {
    ...
    public async listSessions(
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.TesseralTimeoutError("Timeout exceeded when calling GET /v1/sessions.");
            case "unknown":
                throw new errors.TesseralError({
    ...
    public async getSession(
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.TesseralTimeoutError("Timeout exceeded when calling GET /v1/sessions/{id}.");
            case "unknown":
                throw new errors.TesseralError({
                    message: _response.error.errorMessage,
                });
